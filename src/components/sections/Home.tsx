...
export default function Hero() {
  return (
   ...
   <h1 className="font-sans text-5xl md:text-7xl font-bold mb-6  bg-clip-text text-transparent bg-[length:200%_200%] animate-gradientWave">Hi, I'm Kayla Chavez</h1>
