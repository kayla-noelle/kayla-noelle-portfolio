...
export default function Hero() {
  return (
   ...
   <h1 className="font-sans text-5xl md:text-7xl font-bold mb-6 text-gray-900 dark:text-white">Hi, I'm Kayla Chavez</h1>
   <p className="font-sans text-gray-900 dark:text-gray-300 text-lg mb-8 max-w-lg mx-auto">
    I'm a front-end developer who loves crafting beautiful and functional web experiences.
   </p>
   <div className="flex justify-center space-x-4">
    <a href="#resume" className="bg-[#20BF55] text-white px-6 py-3 rounded text-lg font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(32,191,85,0.4)]">
      View Resume
    </a>
