...
return(
    <section id="projects" className="py-16 flex flex-col items-center justify-center p-8 bg-white">
        ...
        <div className="flex items-center gap-6 mt-4">
          ...
          <a href="https://github.com/kayla-noelle" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-[#1c1c1c] hover:text-[#2C7A7B] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
